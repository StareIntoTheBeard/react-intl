...
const defaultFormatMessage = (
  ...
  let messages : any =
    ...
    "teaspoon":"{count, plural, = 0 {teaspoon} una {teaspoon} otra {teaspoons}}",
    "tablespoon":"{count, plural, = 0 {tablespoon} una {tablespoon} otra {tablespoons}}",
    "ounce":"{count, plural, = 0 {ounce} uno {ounce} otro {ounces}}",
    "cup":"{count, plural, = 0 {cup} one {cup} other {cup}}",
    "pint":"{count, plural, = 0 {pint} una {pint} otra {pints}}",
    "quart":"{count, plural, = 0 {quart} uno {quart} otro {quart}}",
    "gallon":"{count, plural, = 0 {gallon} uno {gallon} otro {gallons}}",
    "pound":"{count, plural, = 0 {pound} una {pound} otra {pounds}}",
    "inch":"{count, plural, = 0 {inch} one {inch} other {inches}}",
    "wholePlural":"{count, plural, = 0 {entero} uno {entero} otro {entero}}",
    "splash":"{count, plural, = 0 {splash} uno {splash} otro {salpicaduras}}",
    "bunch":"{count, plural, = 0 {manojo} uno {manojo} otro {manojos}}",
    "pinch":"{count, plural, = 0 {pinch} one {pinch} other {pinches}}",
