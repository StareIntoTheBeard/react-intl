...
const defaultFormatMessage = (
  ...
  "quart":"'{cuenta, plural, = 0 {cuarto} uno {cuarto} otro {cuarto}}",
  ...
  "splash":"'{cuenta, plural, = 0 {splash} uno {splash} otro {salpicaduras}}",
  "bunch":"'{cuenta, plural, = 0 {manojo} uno {manojo} otro {manojos}}",
  "pinch":"'{count, plural, = 0 {pinch} one {pinch} other {pinches}}",
  "errorFlash": "Ocurrió un error."}
}
let locale : any = navigator.language.split("-")[0];
let config : any =  {
  ...DEFAULT_INTL_CONFIG,
